...
default_args = {
    ...
    'email': ['yusraejaz.create@gmail.com'],
    'email_on_failure': False,
    'email_on_retry': False,
    'max_active_runs': 1,
}

# {"table_name":"example_abc","input_file":"s3://developement-purpose/user/yusraejaz/samples_output/username-password-partition/part=2019,NA"}
